//// zare_nk_050428_okk(1)(in file dar projehaye js mesle nextjs ya reactnative , ... karbord dareh, va karesh modiriate formate codezani ast(bishtar 
...
module.exports = {
  ...
  //// age migoftim arrowParens: 'always' hamishe barnameh automat be (x) => x * 2 tabdil mikoneh)
  ...
  trailingComma: 'all',  ////zare_nk_050214_nokteh(age trailingComma: 'all', bashe, dar araye ha ya object ha barnameh automat bade akharin ozv ham yak virgool ezafeh 
