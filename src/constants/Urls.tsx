...
export const NextJsApiAuthUrl = "https://testotm.sarinmehr.com/api/auth/";   ////zare_nk_050420_nokteh(api be site hamyar baraye barresiye token ba codehaye samte server (chon dar reactnative codeha kollan samte client hastand))  
